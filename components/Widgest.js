...
import Trending from "./TradingResults";
  ...
  return (
    <div className="hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5 ">
      <div className="sticky top-0 py-1.5  bg-slate-900 z-50 w-11/12 xl:w-9/12">
        <div className="flex items-center  bg-slate-700 p-3 rounded-full relative">
      ...
      <div className="text-[#d9d9d9] space-y-3 bg-slate-700 bg-opacity-20 pt-2 rounded-xl w-11/12 xl:w-9/12">
